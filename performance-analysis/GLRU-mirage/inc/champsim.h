...
//#define HUGE_PAGE //uncomment this line to activate huge page of 2 MB
...
#ifdef HUGE_PAGE
        #define PAGE_SIZE 2097152 //1073741824 org:4096
        #define LOG2_PAGE_SIZE 21 //30 org:12
#else
...
#define INTERCONNECT_ON  0 // to enable/disable INTERCONNECT
...
#define Deprioritize_attacker 0
extern uint32_t stall_the_attacker[NUM_CPUS], attacker_delay[NUM_CPUS];
...
extern uint8_t warmup_complete[NUM_CPUS], 
               ...
               knob_cloudsuite,
               knob_low_bandwidth;
extern uint64_t total_load_rob_stall_cycles[NUM_CPUS] , total_rob_stall_cycles[NUM_CPUS],rob_stall_count[NUM_CPUS], load_rob_stall_count[NUM_CPUS];;
...
#ifdef HUGE_PAGE
    std::uniform_int_distribution<uint64_t> dist{0, 0xFFFFFFF}; // used to generate random physical page numbers
#else
